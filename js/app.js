...
export const PROJECTS = [
  {
    ...
    tags: ["UX Research", "Media Architecture", "Thesis"],
    categories: ["ux", "spatial", "research"],
  ...
  },
  {
    title: "Play Palooza",
    subtitle:
      "Freelance UX Research, Content Design & App Design · +40% Engagement",
    tags: ["UX Research", "Content Design", "App Design", "Figma"],
    categories: ["ux"],
    label: "+40% Engagement",
  ...
  },
  {
    ...
    tags: ["XR / VR", "Spatial UX", "Usability Research"],
    categories: ["ux", "spatial", "research"],
    label: "Spatial Mindfulness",
    image: "assets/project-05-headspace-vr-cover.png",
    featured: true,
    href: "work/headspace-vr.html",
  },
  {
    title: "UNBOUND",
    subtitle: "QAGOMA Website Redesign · Content & Web Design",
    tags: ["UI Design", "Content Design", "Web Design", "Front-End"],
    categories: ["ux"],
  ...
  },
  {
    ...
    tags: ["HCI Research", "Systems Map", "Research"],
  ...
  },
  {
    ...
    subtitle:
      "Selected Works · Landscape, Architecture & Fine Arts (Till 2024)",
    tags: ["Architecture", "Landscape Design", "Fine Arts"],
    categories: ["spatial", "research"],
...
function observeReveal() {
          ...
          if (entry.target.classList.contains("stat__number")) {
            const target = parseInt(
              entry.target.dataset.count ||
                entry.target.innerText.replace(/[^0-9]/g, ""),
              10,
            );
            entry.target.dataset.suffix = entry.target.innerText.replace(
              /[0-9]/g,
              "",
            );
  ...
  document
    .querySelectorAll(".reveal, .reveal-stagger, .section-line, .stat__number")
    .forEach((el) => {
...
function animateValue(obj, start, end, duration) {
  ...
  const step = (timestamp) => {
    ...
    obj.innerHTML =
      Math.floor(progress * (end - start) + start) + (obj.dataset.suffix || "");
